...
class SignoutDialoge extends StatefulWidget {
  const SignoutDialoge({
    Key? key,
  }) : super(key: key);

  @override
  SignoutDialogeState createState() => SignoutDialogeState();
}

class SignoutDialogeState extends State<SignoutDialoge> {
  @override
